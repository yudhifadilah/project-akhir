...
<section class="content">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?= base_url('/admin/articles/delete') ?>" method="post" id="formHapusArtikel">
    ...
    $(document).ready(function () {
        ...
        function tbl_articles() {
            $("#tbl-articles").DataTable({
                ...
                "lengthChange": true, // Enable the option to change the number of records displayed per page
                "pageLength": 10, // Set the default number of records displayed per page
                }
            });
        }
