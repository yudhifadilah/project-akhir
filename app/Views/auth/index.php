    ...
    <div class="container">
        ...
        <div class="signin-content">
            <div class="signin-image">
                <figure><img src="<?php echo base_url() ?>/assets/img/portfolio/lg.svg" alt="sing in image" width="100%" height="100%"></figure>
            </div>
            ...
            <a href="/" class="signup-image-link">Kembali Ke Beranda? Tekan Disini</a>
            <?= form_close(); ?>
        </div>
    </div>
    </div>
